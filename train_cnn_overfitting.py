...
print(f"Training CNN on limited data (overfitting experiment) on: {device}\n")
...
axes[1].set_title('CNN: Training vs Validation Accuracy\n(Limited Data: 250 samples/class)', fontsize=13, fontweight='bold')
axes[1].legend(fontsize=11)
axes[1].grid(True, alpha=0.3)

fig.tight_layout()
plt.savefig('training_curves_cnn_overfitting.png', dpi=150, bbox_inches='tight')
print("Training curves saved to training_curves_cnn_overfitting.png")
plt.show()

print("\nCNN overfitting experiment complete!")
